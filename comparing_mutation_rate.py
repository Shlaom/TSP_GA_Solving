...
for p in range(9):
    ...
    plt.title('Mutation rate: ' + str(mutation_rate) + '  /  ' + str(round(elapsed_time)) + 'sec  /  generation: ' + str(generation))
    plt.xlabel('Num of iteration')
    plt.ylabel('Fitness score')
    plt.grid(True)
    mutation_rate += 2
    time.sleep(1)
plt.suptitle('Size of pop: ' + str(size_of_pop) + '   /   Crossover rate: ' + str(crossover_rate) + '   /   Num of mutation exchange: ' + str(num_mutation_exchange))
plt.show()