...
for p in range(10):
    ...
    plt.ylim([0.5, 1])
    plt.xlim([0, 4000])
    plt.title('mutation rate: ' + str(mutation_rate))
    time.sleep(1)
plt.suptitle('size_of_pop: ' + str(size_of_pop) + 'crossover_rate: ' + str(crossover_rate) + ', num_mutation_exchange: ' + str(num_mutation_exchange))
plt.show()