...
for p in range(9):
    ...
    plt.title('Size of population: ' + str(size_of_pop) + '  /  ' + str(round(elapsed_time)) + 'sec  /  generation: ' + str(generation))
    plt.xlabel('Num of iteration')
    plt.ylabel('Fitness score')
    plt.grid(True)
    size_of_pop += 20
    time.sleep(1)
plt.suptitle('Crossover_rate: ' + str(crossover_rate) + '   /   Mutation_rate: ' + str(mutation_rate) + '   /   Num_mutation_exchange: ' + str(num_mutation_exchange))
plt.show()